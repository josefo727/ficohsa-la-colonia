...
class GeneralSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                'name' => 'VTEX_APP_KEY',
                'value' => 'vtexappkey-massivespace-GMORVY',
                'description' => 'App key de Vtex.',
                'type' => 'password'
            ],
            [
                'name' => 'VTEX_APP_TOKEN',
                'value' => 'FVZCTBMFTHUHYAFMWTLONYIWSEJXQBUXPZGJIVISGBKPHFTEHJLSCAZGREIPSNRNVLSBYAJKQWPWXJOSBCRMIQESKLFLXMUJPSFZZLURXHKHWBCGLLRHVLVCKJDFHZRK',
            ...
            [
                ...
                'value' => 'https://massivespace.myvtex.com',
