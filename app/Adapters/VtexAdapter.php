...
class VtexAdapter
{
    ...
    {
        return [
            'accountName' => GeneralSetting::getValue('VTEX_ACCOUNT_NAME'),
            'environment' => $environment ?? GeneralSetting::getValue('VTEX_ENVIRONMENT'),
            'appKey'      => GeneralSetting::getValue('VTEX_APP_KEY'),
            'appToken'    => GeneralSetting::getValue('VTEX_APP_TOKEN'),
        ];
    }
}
